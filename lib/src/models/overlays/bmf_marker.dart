...
class BMFMarker extends BMFOverlay {
  ...
  BMFMarker.fromMap(Map map)
    ...
    // this.isOpenCollisionDetection = map['isOpenCollisionDetection'] as bool;
    // this.collisionDetectionPriority = map['collisionDetectionPriority'] as int;
    // this.isForceDisplay = map['isForceDisplay'] as bool;
  }
